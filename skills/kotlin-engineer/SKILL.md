...
description: >
  Encodes the project's Kotlin 2.x implementation policy and the pitfalls that
  recur in review. Use whenever writing, modifying, refactoring, or explaining
  Kotlin code, especially coroutines, Flow, null-safety, Java interop, Gradle
  Kotlin DSL, and public API design.
---
