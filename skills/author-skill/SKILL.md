...
These are the things to pin down — but resolve them from the conversation where you can, and when you do need to
ask, ask **one question at a time** (per this repo's `AGENTS.md`), not all at once:
