...
3. **Check Spine-specific rules** (from
   ...
   - `group` equals `"spine"`. Once the shared constant exists, a bare
     literal `"spine"` where the constant could have been used becomes a
     Nit whose recommended replacement is the constant.
